...
**Status:** ✅ SHIPPED + enabled by default — `source_enrichment.js` / `outlet_metadata.js` wired into `newsInvokeGemini` (`index.js:871-886`); live threshold is **0.20** (this doc's 0.35 is superseded). [Corrected 2026-09-08 doc-staleness sweep — prior "Draft … ready to implement" was stale.] Original draft audit 2026-05-18.
