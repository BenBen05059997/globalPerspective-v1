...
| `CountryPage.jsx` | Map-first country page: full-bleed map hero, then a 3-col EditorialShell — center tabs **Situation / Story Arcs / Causal Web / Coverage** (the `SystemsGraph` causal web was promoted out of the right rail into a full-width center **Causal Web** tab 2026-06-29; tab shows only when `systemsData.nodes` exist), right rail with risk/actors/watch/economic/macro/FX modules | `features/countries/CountryPage.jsx` |
