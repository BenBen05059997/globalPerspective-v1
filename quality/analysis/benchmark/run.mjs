...
import { SYSTEM_PROMPT, assembleContext, buildUserMessage, getLens } from '../../../global-perspectives-starter/frontend/src/utils/analysisPrompt.js';
...
// Deterministic cross-check on calibration: spread of probabilities the analyst stated.
// Flat spread (all ~60-70%) is the under-differentiation smell the live run exposed.
function probSpread(text) {
  const pts = [];
