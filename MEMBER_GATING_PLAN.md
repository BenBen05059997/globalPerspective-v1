...
- [~] **P6** Perk surfacing — mention the member perks contextually (§7). **P6a–c BUILT on worktree `feat/perk-surfacing` (commits `25fba7b`/`c0ffa9f`/`2b45911`), verify-green (0 errors, 192 tests, build ✓), NOT deployed.** P6a Home count-fix + hint · P6b weekly+breaking email footers · P6c Studio upsell. P6d (bell) / P6e (ThreadPage) deferred. ⚠️ P6b touches the live sender → send-to-self before next Sunday.
