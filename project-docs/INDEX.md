...
- **[ECONOMY_CONSOLE_DISCUSSION.md](redesign-ux/_active/ECONOMY_CONSOLE_DISCUSSION.md)** — /economy in the console style: verified current state (prices live, disruptions frozen since 12 Sep, TTL off), references (Offworld ticker+board, TradingView story markers, Bloomberg, Finviz, Kpler), options A/B/C and decisions E1–E8. Discussion, 2026-09-25.
