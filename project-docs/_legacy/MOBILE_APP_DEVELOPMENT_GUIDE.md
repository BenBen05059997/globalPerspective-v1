...
> ⚠️ **ARCHIVED 2026-09-08 (doc-usage audit) — no mobile app exists; the consumer-mobile direction was abandoned for the enterprise B2B pivot.** Moved to `_legacy/`, kept for the audit trail. Current state: see `../INDEX.md`.
