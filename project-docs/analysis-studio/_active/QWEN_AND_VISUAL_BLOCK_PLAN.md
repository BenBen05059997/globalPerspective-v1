...
**Fix (already applied to `src/features/analysis-studio/lib/analysisPrompt.js`):**
...
`PROVIDERS` in `src/features/analysis-studio/lib/llm.js` with the generic `dashscope-intl` host. But
...
1. `src/features/analysis-studio/lib/llm.js`
...
2. `src/features/analysis-studio/lib/byok.js`
...
3. `src/features/analysis-studio/components/ProviderModal.jsx`
...
4. `src/features/analysis-studio/AnalysisStudio.jsx`
...
- Stage ONLY these files (the main checkout has unrelated uncommitted work — do NOT
  touch it): `src/features/analysis-studio/lib/analysisPrompt.js`,
  `src/features/analysis-studio/lib/llm.js`, `src/features/analysis-studio/lib/byok.js`,
  `src/features/analysis-studio/components/ProviderModal.jsx`,
  `src/features/analysis-studio/AnalysisStudio.jsx`,
