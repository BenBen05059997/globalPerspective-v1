...
- **[STAGE0_FIXES_PLAN.md](architecture/_active/STAGE0_FIXES_PLAN.md)** + task **[TASK_2026-09-24_stage0_fixes.md](architecture/_active/TASK_2026-09-24_stage0_fixes.md)** — Fix-first list from the page review (SEO 404 via Worker SPA fallback, freshness honesty, parked-credits copy, onboarding-tour mobile block, request de-dupe, route lazy-loading, page titles, /daily arrows). Operator-approved; executing; both deploys (site + Worker) operator-gated. 2026-09-24.
