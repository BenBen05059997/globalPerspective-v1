...
**Status: ⚠️ SUPERSEDED — describes the deleted Paddle-era design. Current spec → [`POLAR_BILLING_PLAN.md`](../billing/_active/POLAR_BILLING_PLAN.md).**
