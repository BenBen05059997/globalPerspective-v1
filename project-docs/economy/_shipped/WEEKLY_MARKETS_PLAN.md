...
**Status:** ✅ SHIPPED — `newsWeeklyMarkets` Lambda + `weekly_markets` action + `WeeklyMarketsView` + `/weekly-markets` route; `TriggerWeeklyMarkets` cron ENABLED (live-verified). [Corrected 2026-09-08 doc-staleness sweep — prior "PROPOSED (not built)" was stale.] Authored 2026-06-27.
