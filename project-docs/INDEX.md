...
- **[STORY_DOSSIER_BOARD_DESIGN_BRIEF.md](redesign-ux/_active/STORY_DOSSIER_BOARD_DESIGN_BRIEF.md)** — Story page → "Story dossier" and story board → "Intel board" (console style), with the /spider-demo causal web merged in (dossier section 2 + board WEB view). Concept approved; 3 layout toggles open on wireframe row 3. 2026-09-25.
