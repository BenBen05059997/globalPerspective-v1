...
import CountryWhatChanged from '@/components/atoms/CountryWhatChanged';
import RiskScorecard from '@/components/atoms/RiskScorecard';
import SeverityBadge from '@/components/atoms/SeverityBadge';
import DirectionArrow from '@/components/atoms/DirectionArrow';
import { formatDateLabel } from '@/utils/dateUtils';
import { getBroadRegionsForCountry } from '@/utils/countryMapping';
import WeeklyMap from '@/components/WeeklyMap';
import ShareButtons from '@/components/ShareButtons';
import CopyBriefing, { formatCountryBriefing } from '@/components/CopyBriefing';
