...
Sibling to [`ECONOMIC_DISRUPTION.md`](../ECONOMIC_DISRUPTION.md) (concept) and [`ECONOMIC_DISRUPTION_PLAN.md`](../_shipped/ECONOMIC_DISRUPTION_PLAN.md) (implementation). The plan below is the original spec — see **Status & Roadmap** for what's actually shipped and when to check next.
