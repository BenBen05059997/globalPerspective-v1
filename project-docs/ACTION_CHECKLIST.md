...
| F1 Studio | Analysis Studio v2, story mode for your question: map + slides + time bar; our data (legend tokens) vs this run (amber hatching); scenario + compare drawn with real data; preview states briefing / running / debrief / failed checks / shared (**proposed**, see TRACK_RECORD_AND_STUDIO_RULING.md "Studio page design") |
