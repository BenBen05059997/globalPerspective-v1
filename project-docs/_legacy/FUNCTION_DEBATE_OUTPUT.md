...
> ⚠️ **ARCHIVED 2026-09-08 (doc-usage audit) — spent one-time artifact.** Its actionable content was absorbed into `../audits/BACKEND_TODO.md` and shipped code; retained for history only.
