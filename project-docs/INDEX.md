...
- **[REPO_RESTRUCTURE_DESIGN_2026-09-24.md](architecture/REPO_RESTRUCTURE_DESIGN_2026-09-24.md)** — DESIGN ONLY, awaiting operator go: frontend `src/` → `app/` + `shared/` + 13 `features/` (every one of 193 files mapped), `@/` alias, 13 reversible phases (P0–P12, ~14–17h; P0+P1 ~3h standalone). Backend Lambda paths deliberately NOT moved (feature→Lambda index instead). 2026-09-24.
- **[FRONTEND_RESTRUCTURE_EXECUTION_PLAN.md](architecture/_active/FRONTEND_RESTRUCTURE_EXECUTION_PLAN.md)** + task file **[TASK_2026-09-24_frontend_feature_folders.md](architecture/_active/TASK_2026-09-24_frontend_feature_folders.md)** — executable phase-by-phase plan for the restructure design (P0–P12, per-phase file moves/verify/browser checklist/rollback). §0 operator decisions pending; NOT started. 2026-09-24.
