...
|---|---|---|---|---|---|
| A1 · Site shell | N1 menu, footer, site-wide computed "paused" line, tour targets, page guard | K-d (default: hide the white paper) | **Next** | — | — |
| A2 · Phone tab bar | P1 bottom tab bar under 900px | A1 | queued | — | — |
