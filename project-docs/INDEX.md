...
- **[COUNTRY_VIEW_DISCUSSION.md](redesign-ux/_active/COUNTRY_VIEW_DISCUSSION.md)** — Country view: split into map country card + Studio deep-dive + public URL; 8 reader questions × our data (live freshness), proposed card (infobox, risk/direction/watch triad, 4 chips, stories, dated watch triggers, money line, freshness), decisions C1–C8. Discussion, 2026-09-25.
